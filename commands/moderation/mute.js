...
module.exports.run = async (client, message, args) => {
	...
	const notice3 = new Discord.MessageEmbed()
		.setDescription(`I don't have permission to mute people!`)
		.setColor("RED");
	...
	const sdfsdfsdfsssd = new Discord.MessageEmbed()
		.setDescription(`Please Type the muting period!`)
		.setColor("RED");
	const dddfs = new Discord.MessageEmbed()
		.setDescription(
			`You can only maxium muting this user for 14 days!`
		)
		.setColor("RED");
	...
	const bruhembed = new Discord.MessageEmbed()
		.setDescription(
			`**${tomute.username}#${tomute.discriminator}** had been muted before!`
		)
		.setColor("GREEN");
