...
module.exports.run = async (client, message, args) => {
	...
	const notice3 = new Discord.MessageEmbed()
		.setDescription(` I don't have permission to unmute people!`)
		.setColor("RED");
	...
	const notice2 = new Discord.MessageEmbed()
		.setDescription(`You cannot do this for you!`)
		.setColor("RED");
	...
	const bruhembed = new Discord.MessageEmbed()
		.setDescription(
			` **${member.username}#${member.discriminator}** had not been muted!`
		)
		.setColor("RED");
