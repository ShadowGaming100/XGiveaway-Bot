...
module.exports.run = async (client, message, args) => {
	...
	const notice3 = new Discord.MessageEmbed()
		.setDescription(`I don't have permission to warn people!`)
		.setColor("RED");

	const notice333 = new Discord.MessageEmbed()
		.setDescription(`You must mention someone to warn him/her!`)
		.setColor("RED");
	if (
		!message.guild
			.member(client.user)
	...
	const test1 = new Discord.MessageEmbed()
		.setDescription(
			`Muted **${user.username}#${user.discriminator}** For 1 Hour | **Reached Two Warnings**`
		)
		.setColor("GREEN");
